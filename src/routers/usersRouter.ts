...
userRouter.get('/get_users_dropdown', isAuthenticated, checkPrivilege({ requiredUserRole: 1 }), getUsersForDropdown)
userRouter.get('/get_user/:id', isAuthenticated, getUserById)
userRouter.post('/create_user', isAuthenticated, checkPrivilege({ requiredUserRole: 1 }), createUser)
